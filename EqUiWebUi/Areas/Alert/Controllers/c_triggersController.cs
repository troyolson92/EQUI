...
namespace EqUiWebUi.Areas.Alert.Controllers
{
    ...
    public class c_triggersController : Controller
    {
        ...
        public async Task<ActionResult> Edit([Bind(Include = "id,enabled,discription,sqlStqStatement,smsSystem,smsActivePloeg,initial_state,Cron,alertType,AutoSetStateTechComp,smsOnRetrigger,RunAgainstDatabase,enableSMS")] c_triggers c_triggers)
        {
