...
namespace EqUiWebUi.Areas.PJV.Models
{
    ...
    public partial class RobotDetail
    {
        ...
        public RobotDetail()
        {
            this.RobotProgram = new HashSet<RobotProgram>();
            this.SummaryResult = new HashSet<SummaryResult>();
        }
    
        public int id { get; set; }
        public string name { get; set; }
        public string robotSupplier { get; set; }
        ...
        public virtual ICollection<RobotProgram> RobotProgram { get; set; }
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2227:CollectionPropertiesShouldBeReadOnly")]
        public virtual ICollection<SummaryResult> SummaryResult { get; set; }
    }
}
