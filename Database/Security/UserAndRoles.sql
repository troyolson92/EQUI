...
GO
--
CREATE USER [VCCNET\6308-APP-EQUI-DATA-R-USER] FOR LOGIN [VCCNET\6308-APP-EQUI-DATA-R-USER]
    WITH DEFAULT_SCHEMA = [EqUi];
GO
CREATE USER [VCCNET\6308-APP-EQUI-DATA-RW-USER] FOR LOGIN [VCCNET\6308-APP-EQUI-DATA-RW-USER]
    WITH DEFAULT_SCHEMA = [EqUi];
GO
...
GO
ALTER ROLE [db_accessEquiAdmin] ADD MEMBER [VCCNET\6308-APP-EQUI-DATA-RW-USER]
GO
...
GO
ALTER ROLE [db_accesEquiReadonly] ADD MEMBER [VCCNET\6308-APP-EQUI-DATA-R-USER]
