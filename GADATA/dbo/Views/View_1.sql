...
AS
SELECT        SUM(dbo.WeldMeasurements.NbrWeld) AS Expr1, dbo.WeldMeasurements.Date
...
WHERE        (dbo.Timer.NptId = 5) OR
                         (dbo.Timer.NptId = 6) OR
                         (dbo.Timer.NptId = 7) OR
                         (dbo.Timer.NptId = 8)
GROUP BY dbo.WeldMeasurements.Date
GO
