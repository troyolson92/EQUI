...
SELECT        TOP (100) PERCENT dbo.NPT.Name AS NPT, dbo.Timer.Name AS Timer, SUM(CAST(dbo.UltralogInspections.SmallNugget AS INT)) AS smallnugget, 
                         dbo.Spot.Number AS spot, dbo.ResponsibilityWM.responsibilityWM
...
GROUP BY dbo.UltralogInspections.SmallNugget, dbo.Spot.Number, dbo.Timer.Name, dbo.NPT.Name, dbo.ResponsibilityWM.responsibilityWM
ORDER BY smallnugget DESC
GO
...
GO
EXECUTE sp_addextendedproperty @name = N'MS_DiagramPane2', @value = N'5
         Table = 3870
         Output = 720
         Append = 1400
         NewValue = 1170
...
Begin DesignProperties = 
   ...
   Begin CriteriaPane = 
      Begin ColumnWidths = 12
         Column = 3720
         Alias = 169', @level0type = N'SCHEMA', @level0name = N'WELDING', @level1type = N'VIEW', @level1name = N'SmallNuggetsLastWeekV316';
