...
SELECT DISTINCT top 10000		   rt.[controller_name] as 'Robot'
					  ...
					  left join GADATA.EqUi.ASSETS as a on a.controller_name = rt.controller_name
					  AND a.LOCATION = rt.controller_name and controller_ToolID = 1 and controller_type ='NGAC'
